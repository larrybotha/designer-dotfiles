...
## type the following and press enter @defaults write com.apple.finder AppleShowAllFiles -bool true@
## type @killall Finder@ to refresh your Finder with the new setting
## hidden files are now displayed in your Finder as
...
# enter your password nd press enter (Terminal will not show that anything is being typed... don't worry, it is!)
# wait for confirmation that your settings have been updated
# to hide the files that we revealed in step 1
## open Terminal
## type the following and press enter @defaults write com.apple.finder AppleShowAllFiles -bool false@
## type @killall Finder@ to refresh your Finder with the new setting
